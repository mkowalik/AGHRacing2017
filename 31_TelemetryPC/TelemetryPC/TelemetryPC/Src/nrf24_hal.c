...
void nRF24_DevicesInit(void){
	...
	nRF24Devices[0].CSN_GPIO_Port = nRF24_CSN_GPIO_Port;
	nRF24Devices[0].CSN_Pin = nRF24_CSN_Pin;
	nRF24Devices[0].IRQ_GPIO_Port = nRF24_IRQ_GPIO_Port;
	nRF24Devices[0].IRQ_Pin = nRF24_IRQ_Pin;
