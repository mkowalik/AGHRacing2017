...
#define nRF24_CMD_R_RX_PL_WID		(uint8_t)0x60 // Read RX payload width for the top payload in the RX FIFO
#define nRF24_CMD_W_ACK_PAYLOAD		(uint8_t)0xA8 // Write payload for ACK
#define nRF24_CMD_W_TX_PAYLOAD_NOACK(uint8_t)0xB0 // Disable AUTOACK on this specific packet
