...
#define DATA_F_ACC_X_LOCAL_ID		1
#define DATA_F_ACC_X_BYTEOFFSET		((uint8_t) 0)

#define DATA_F_ACC_Y_LOCAL_ID		2
#define DATA_F_ACC_Y_BYTEOFFSET		((uint8_t) 2)

#define DATA_F_ACC_Z_LOCAL_ID		3
#define DATA_F_ACC_Z_BYTEOFFSET		((uint8_t) 4)

#define DATA_F_GYR_X_LOCAL_ID		4
#define DATA_F_GYR_X_BYTEOFFSET		((uint8_t) 0)

#define DATA_F_GYR_Y_LOCAL_ID		5
#define DATA_F_GYR_Y_BYTEOFFSET		((uint8_t) 2)

#define DATA_F_GYR_Z_LOCAL_ID		6
#define DATA_F_GYR_Z_BYTEOFFSET		((uint8_t) 4)
